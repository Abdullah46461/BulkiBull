...
- REST API покрывает бычков и историю взвешиваний;
- mobile app умеет список, поиск, карточку, создание, редактирование и добавление веса;
...
`apps/api` отвечает за REST API, Prisma и работу с PostgreSQL. Бизнес-логика MVP сосредоточена в модуле `bulls`.
